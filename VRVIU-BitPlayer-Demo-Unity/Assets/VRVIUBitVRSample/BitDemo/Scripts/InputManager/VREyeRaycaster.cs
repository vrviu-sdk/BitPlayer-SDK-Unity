...
namespace VRVIU.LightVR.InputManager
{
    ...
    public class VREyeRaycaster : MonoBehaviour
    {
        ...
        [SerializeField] private bool m_ShowDebugRay = false;                   // Optionally show the debug ray.
        [SerializeField] private float m_DebugRayLength = 1200f;           // Debug ray length.
        [SerializeField] private float m_DebugRayDuration = 1f;         // How long the Debug ray will remain visible.
        [SerializeField] private float m_RayLength = 1200f;              // How far into the scene the ray is cast.
