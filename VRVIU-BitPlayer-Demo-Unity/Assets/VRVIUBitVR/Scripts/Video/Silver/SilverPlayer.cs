...
namespace VRVIU.BitVrPlayer
{
    public class SilverPlayer
    {
        ...
        public struct SilverVideoBasicInfo
        {
            public string videoUrl;
            public SilverVideoType videoType;
            public int isVOD;
            public string meshURL;
            public UInt64 durationSeconds;
        }
    ...
    [DllImport("javabridge", CallingConvention = CallingConvention.Cdecl)] private static extern IntPtr getJavaVM();
        ...
        public SILVER_ERROR GetTexture(out IntPtr[] textureData, out Int64 lTimestamp, out Vector3 orientation)
        {
